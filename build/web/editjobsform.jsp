	...
	<div class="container">
	    ...
	    <div class="clearfix"> </div>
            ...
            <ul class="navbar2">
                    ...
                    <li class="navbar2list"><a href="logout">Log Out</a></li>
            </ul>
	    <!--/.navbar-collapse-->
	</nav>
<div class="container">
    <div class="single">  	  
	  <div class="form-container">
        <h2>Update or Delete Jobs Form</h2>
        <form name="jobaddform" action="jobeditservlet" method="post">
          <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="positionName">Position Name</label>
                <div class="col-md-9">
                    <input type="text" path="firstName" name="positionName" class="form-control input-sm" required/>
                </div>
            </div>
         </div>         
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" path="description" name="description" class="form-control input-sm" required/>
                </div>
            </div>
        </div>                          
        <div class="row">
