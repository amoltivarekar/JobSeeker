...
<%
    try{
            String jn=request.getParameter("jobname");
            ...
            PreparedStatement pst=con.prepareStatement("select jobname,jobloc,jobdesc,salaryrange from jobs where jobname='"+jn+"'");
            rs = pst.executeQuery();
            rs.next();
    }
    catch(Exception e){}
...
<div class="container">
    <div class="single">  	  
	  <div class="form-container">
        <h2>Update your selected job</h2>
        <form name="edit" action="jobupdate?posnm=<%out.print(rs.getString(1));%>" method="post">
          <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="positionName">Position Name</label>
                <div class="col-md-9">
                    <input type="text" name="positionName" value="<%out.print(rs.getString(1));%>" class="form-control input-sm" required/>
                </div>
            </div>
         </div>         
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="location" value="<%out.print(rs.getString(2));%>" class="form-control input-sm" required/>
                </div>
            </div>
        </div>
            <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="description" value="<%out.print(rs.getString(3));%>" class="form-control input-sm" required/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" placeholder="20k-50k" name="salaryrange" value="<%out.print(rs.getString(4));%>" class="form-control input-sm" required/>
                </div>
            </div>
        </div>
        <div class="row">
